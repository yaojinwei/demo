 ...
 * @since 2016/9/27
 */
public class ListMultiThreadTest2 {
    private Logger logger = LoggerFactory.getLogger(ListMultiThreadTest2.class);

    public static void main(String[] args) {
        ListMultiThreadTest2 listMultiThreadTest = new ListMultiThreadTest2();
